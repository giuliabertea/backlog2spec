...
- `src/Backlog2Spec.Cli/Commands/SpecCommand.cs` — no structural change; flag parsed and propagated to DI
- `src/Backlog2Spec.Cli/Program.cs` — DI registration branched on `--mock`
- `src/Backlog2Spec.Cli/Agents/MockEnrichmentAgent.cs` — new file
- `src/Backlog2Spec.Cli/Agents/MockSpecGeneratorAgent.cs` — new file
- `src/Backlog2Spec.Cli/Ado/MockAdoClient.cs` — new file
